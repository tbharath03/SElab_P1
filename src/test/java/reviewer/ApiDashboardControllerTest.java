...
import reviewer.rest.ApiDashBoardController;
...
public class ApiDashboardControllerTest {
    ...
    @InjectMocks
    private ApiDashBoardController apiDashBoardController;
    ...
    public void findAllByuserAndStatusForNonEmpty() throws Exception{	
    	...
    	List<Paper> result = apiDashBoardController.getAllPapers(user.getEmailId());
